                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Vijay Girase</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="http://www.linkedin.com/in/vijay-girase-002100192"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/Vijaygirase18/mywebsite.git"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/vijayrajput_9545/"
                              target="newtab"
                            >
                              <i
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        At present time  I create many designs for Web
                        Application. I create the beauty of the site.
                        I'm responsible for the site's  technical aspects,
                ...
                <div className="row love-row wow fadeIn">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".3s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Love to do UI design for new product</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Vijay Himmatsing Girase</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a MERN stack  developer from pune, India. I enjoy
                      ...
                      <a
                        ...
                        href="https://drive.google.com/file/d/1VOzkrBtrGXdojSVsaASVIhQvmuCYzCDk/view?usp=drive_link"
                        target="_blank"
                        style={{textDecoration:"none",tcolor:"black"}}
                      >
                        See Resume
                      </a>
                    ...
                    <div className="content">
                      <div className="col">
                        <ul id="skill-main">
                          ...
                          <li>
                            <h3>Node.Js/Express.js - 60%</h3>
                          </li>
                          <li>
                            <h3>MongoDB/MySQL - 85%</h3>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from S.R. Deore Madyamik vidyaly Boris Maharastra, India.
                        </p>
                        <h3> HighSchool</h3>
                        <h2>2016-2018</h2>
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from SSvps Late karmaveer Dr.PR. Gogery Science college Dhule,
                          Maharastra, India.
                        </p>
                    ...
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            href="https://prgscience.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            SSVps ( Late Karmaveer Dr. P. R. Ghogrey Science College )
                          </a>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".4s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Currently learning Full-Stack (MERN) from{" "}
                          <a
                            href="https://www.iteducationcentre.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                          IT Education Centre,pune,Maharashtra 
                          </a>
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          I did an internship at TreueTechnologes  as a
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “vijay was a real pleasure to work with
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Vijay's a clear communicator with the
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Vijay has done a fantastic job overall.
                ...
                <div className="container">
                  <div className="row">
                      ...
                      <div className="blog-main">
                        ...
                        <div className="blog-head">
                          ...
                          >
                            <h3>
                              <strong>
                                The importance of UI | Software Engineering
                              </strong>
                            </h3>
                          </a>
                        </div>
                    ...
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        <a
                          href="https://retool.com/blog/how-to-build-a-react-form-component"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <img
                        ...
                        <div className="blog-head">
                          ...
                          >
                            <h3>
                              <strong>Form Example React </strong>
                            </h3>
                          </a>
                        </div>
                        <div className="blog-bottom">
                          <p>
                            Laravel  form example tutorial. In this post, i
                            will teach from starting on how to send form data on
                            controller and how to insert form data in database
                            using React. If you are trying to create form
                            and want to insert form data into database using
                            laravel latest version. So this post will help you
                    ...
                    <div className="row" style={{ textAlign: "center" }}>
                      <a
                        href="https://github.com/Vijaygirase18"
                        target="newtab"
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:contact.vijayhgirase2000@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
                        ...
                        >
                          contact:vijayhgirase2000@gmail.com
                        </a>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 contact-colamn">
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d242117.70906969727!2d73.69815309340439!3d18.524870610788835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf2e67461101%3A0x828d43bf9d9ee343!2sPune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1708864800074!5m2!1sen!2sin" 
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
